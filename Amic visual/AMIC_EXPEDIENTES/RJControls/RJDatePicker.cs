...
namespace AMIC
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = AMIC.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = AMIC.Properties.Resources.calendarDark;
                else calendarIcon = AMIC.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
